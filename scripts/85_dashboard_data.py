...
def main():
    ...
    discrepancies = [
        ...
        {"id": "D6", "comparison": "US: OECD net (CY) / ForeignAssistance (FY) / CRS gross, 2022",
         "magnitude": "$129m / $206m / $130m", "verdict": "EXPLAINED",
    ...
    sources = [
        ...
        {"name": "US ForeignAssistance.gov (mirror)", "side": "donor", "status": "med",
